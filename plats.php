...
function platscuisines_V02(){
    ...
    $plat = ""; //Variable string contenant la clé courante du tableau
    $une_commande = array(); //Variable correspondant aux tableau des quantités commandées ou des prix en fonction de la contenance de chaque plats
    $qte = 0 // Variable entière correspondant à la clé du tableau de chaque plat
